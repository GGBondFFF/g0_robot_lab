...
```
findsource/g0_robot_lab/g0_robot_lab-maxdepth5-type d |sort
find docs-maxdepth2-type f |sort
```
...
```
ls-lhsource/g0_robot_lab/g0_robot_lab/assets/robots/g0/usd/g0.usd
```
