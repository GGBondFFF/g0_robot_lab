...
class G0RobotLabSceneCfg(InteractiveSceneCfg):
    """Configuration for the G0 robot locomotion scene."""
    ...
    # robots
    robot: ArticulationCfg = G0_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
    # sensors
...
class RewardsCfg:
    ...
    joint_deviation_arms = RewTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg(
                "robot",
                joint_names=list(G0_ARM_JOINT_NAMES),
            )
        },
    )
    ...
    joint_deviation_waists = RewTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg(
                "robot",
                joint_names=list(G0_WAIST_JOINT_NAMES),
            )
        },
    )
    ...
    joint_deviation_legs = RewTerm(
        func=mdp.joint_deviation_l1,
        # code base is -1, gpt suggest weight = -0.2
        weight=-1.0,
        params={
            "asset_cfg": SceneEntityCfg(
                "robot",
...
@configclass
class G0RobotLabEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the G0 robot environment."""

    # Scene settings
    scene: G0RobotLabSceneCfg = G0RobotLabSceneCfg(num_envs=4096, env_spacing=2.5)
    # Basic settings
